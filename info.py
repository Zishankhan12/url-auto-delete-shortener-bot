...
BOT_TOKEN = environ.get('BOT_TOKEN', "6577506138:AAGuREWr26zc7cM6u4JFn5Z1IC4gqZyrxXQ")
...
PICS = (environ.get('PICS', 'https://graph.org/file/0a417e27f0423509166c5.jpg')).split()
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001835721669')
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Zishankhan911:zkhan12345@cluster0.pnwq7om.mongodb.net/?retryWrites=true&w=majority")
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001942980809')).split()]
